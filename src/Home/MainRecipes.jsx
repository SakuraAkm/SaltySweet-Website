...
export default function MainRecipes(props){
    return (
        <section id="adviced-recipes">
                <h1 id="presentation" className="text-center container mx-auto">SaltySweet is a place where everyone can learn to cook, no matter if you are an expert or an amateur, this place is right for you</h1>
